...
class payment: UIViewController, UITextFieldDelegate {
    ...
    @objc func validation_before_submit() {
        ...
        if (cell.txt_card_holder_name.text == "") {
            self.alert_popup_appear()
        } else if (cell.txt_card_number.text == "") {
            self.alert_popup_appear()
...
extension payment: UITableViewDataSource , UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell:payment_table_cell = tableView.dequeueReusableCell(withIdentifier: "payment_table_cell") as! payment_table_cell
...
class payment_table_cell: UITableViewCell {
